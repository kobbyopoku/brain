...
- **Website**: https://nousresearch.com
- **Notable products**:
  - [[wiki/entities/hermes-agent|Hermes Agent]] — MIT-licensed self-improving multi-platform agent CLI (Feb 2026, 150k+ stars per Shann Holmberg May 2026; verify before relying).
