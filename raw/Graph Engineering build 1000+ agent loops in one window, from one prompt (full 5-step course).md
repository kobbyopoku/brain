...
created: 2026-07-22
description: "THE Loop Engineering's successor and the workflow that runs your agents 10x wider...Most people who build a multi-step agent end up with a s..."
tags:
  - "clippings"
  - "agentic-engineering"
  - "graph-engineering"
---
![Image](https://pbs.twimg.com/media/HNwz645WsAAZOIL?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNwdslFXAAAlMrK?format=png&name=large)

And Claude Code shipped the tooling to build these directly: [dynamic workflows](https://claude.com/blog/introducing-dynamic-workflows-in-claude-code)
...
![Image](https://pbs.twimg.com/media/HNwd857WkAAfvq-?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HNweGVPXYAE__QE?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HNwfzGwWEAA83ci?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HNwf6ONW8AAEKbd?format=png&name=large)
...
**What the ceiling looks like** [https://simonwillison.net/2026/Jul/8/rewriting-bun-in-rust/](https://simonwillison.net/2026/Jul/8/rewriting-bun-in-rust/)
...
![Image](https://pbs.twimg.com/media/HNwgAJbWYAAD93v?format=png&name=large)
...
> **Draw the graph. Stay the architect.** Start with the prerequisite: [Loop Engineering](https://x.com/0xCodila/status/2072329149520232639) \- the single loop this is built on [@0xCodila](https://x.com/@0xCodila)