...
source: "https://x.com/zachlloydtweets/status/2077056692987027758"
author:
  - "[[@zachlloydtweets]]"
published: 2026-07-14
created: 2026-07-21
description: "Software development is about to undergo yet another major change: the shift from interactive coding agents to cloud software factories. The..."
tags:
  - "clippings"
  - "software-factories"
---
![Image](https://pbs.twimg.com/media/HNJvyblWkAAXBqS?format=jpg&name=large)
...
Cloud factories are becoming increasingly popular (they are a variant of an agentic “loop”), so much so that one of the main tracks at the mainstage of the AI Engineer World Fair [was dedicated entirely to factory engineering](https://www.ai.engineer/worldsfair/schedule?track=Software+Factories).
...
2. Triage agent runs and tries to understand and repro issueIf it determines the task is automatable → hand it to the Implementation agent - If it needs specs because of scope → have the spec agent iterate with a human to come up with a spec - If it’s ambiguous → get human input and re-run, or just decide to park the issue for now
...
![Image](https://pbs.twimg.com/media/HNJu34xWoAA_69g?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNJu69jXkAAF8KK?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNJvAUrXUAACo8p?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNJvGH6WMAEe4kp?format=jpg&name=large)
...
Illustrations by [Dan Roam](https://www.linkedin.com/in/danroam/).