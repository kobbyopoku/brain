...
created: 2026-05-09
description: "a system that finds your ideas, drafts them in your voice, publishes them, and learns from what works. it took my account to 5M impressions ..."
tags:
  - "ai"
---
![Image](https://pbs.twimg.com/media/HHzWpG8WQAADqpF?format=jpg&name=large)

a system that finds your ideas, drafts them in your voice, publishes them, and learns from what works. it took my account to 5M impressions in 2 weeks and 100K bookmarks in 2 months. content is only as good as the person and the system behind it. low effort going into curating ideas and writing means low-quality content coming out the other side. this article gets you started on building your own content moat. I built a system that optimises for one thing: > **bookmarkable content** a kind of post that screams enough VALUE for a reader to click the bookmark button and add it to their second brain for reference. Example of my 1 million impression post:
...
![Image](https://pbs.twimg.com/media/HHzs3OiXAAAy80S?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HHzOLI0XgAEQfx6?format=jpg&name=large)

I co-founded [@LunarStrategy](https://x.com/@LunarStrategy) , where we deploy a similar Content OS for our clients.
...
![Image](https://pbs.twimg.com/media/HHzPAEWWgAMfyjB?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HHzSNHHXUAAj3bx?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HHzRT9DXIAUdG_E?format=jpg&name=large)
...
> Mar 2
> 
> I built a 4-agent system that writes X content. I give it a topic. It searches X for relevant tweets, stores the research, generates ideas with different hook angles, writes a draft in my voice, and pushes it to Typefully. The pipeline: > Research: pulls tweets and stores them
...
![Image](https://pbs.twimg.com/media/HHzTYWfWcAAHesr?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HHzXIqKXsAM6JJK?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HHzXaZiXMAQg3eL?format=jpg&name=large)
...
open source and self-hostable, repo is gitroomhq/postiz-app, built by [@wickedguro](https://x.com/@wickedguro)
...
Try it out here: [https://postiz.com/](https://postiz.com/)

![Image](https://pbs.twimg.com/media/HHzKHl-WIAslLlH?format=jpg&name=large)
...
be first to know when this system blueprint gets released: [https://bookmarkable.io/](https://bookmarkable.io/)
...
[https://postiz.com/](https://postiz.com/) - Thank you to the Postiz team for collaborating on this article.
