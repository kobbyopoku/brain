...
created: 2026-07-22
description: "This is a complete A–Z breakdown of Kimi K3 what it is and how to run your entire business using only AI AgentsThis will change everything a..."
tags:
  - "clippings"
  - "company-os"
  - "agent-tooling"
---
![Image](https://pbs.twimg.com/media/HNxALC5bsAMkzxC?format=jpg&name=large)
...
> **TLDR;** If you don't want to read a 4480-word article, here is the GitHub repo which you can give to your agent. [https://github.com/codejunkie99/meridian-company-os](https://github.com/codejunkie99/meridian-company-os) **Bookmark these builds before you forget.**
...
I built one ([meridian-company-os](https://github.com/codejunkie99/meridian-company-os), MIT licensed) and it is the reference for this guide, not the point of it. The point is the nine elements underneath it, because those are the elements underneath any company OS you will ever build.

Bookmark these 9 builds before you forget.

![Image](https://pbs.twimg.com/media/HNw4kCuacAA1lzL?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNw4xSlaYAEWmy-?format=jpg&name=large)
...
One regeneration was needed here. K3's first pass put every task in in\_progress, which fails the "every status at least once" line. The fix was not editing the seed; it was that line getting added to the prompt, then kimi -p again. Fix the prompt, never the file.
...
And exactly one interval, wired by a follow-up kimi -p edit scoped to a single hook: while simRunning, dispatch {type:"tick"} every TICK\_MS, clear on cleanup, intervals nowhere else.
...
![Image](https://pbs.twimg.com/media/HNw5LFZawAA9fQP?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNw5GpGaQAItZhh?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNw48dya8AAP5EV?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNw44I0aMAAb6iI?format=jpg&name=large)
...
Built from my own notes while constructing the reference repo; every file was generated by Kimi K3 through the Kimi Code CLI, and a frontier model edited this prose and handled one escalated build (the reducer). The claims are checkable against ([https://github.com/codejunkie99/meridian-company-os](https://github.com/codejunkie99/meridian-company-os)).
