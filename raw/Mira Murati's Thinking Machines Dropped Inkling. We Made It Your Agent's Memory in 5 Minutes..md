...
source: "https://x.com/Vectorizeio/status/2079662235387850935"
author:
  - "[[@Vectorizeio]]"
published: 2026-07-21
created: 2026-07-22
description: "On July 15, Thinking Machines Lab shipped Inkling, the first open-weights model from Mira Murati's new lab. A 975-billion-parameter mixture-..."
tags:
  - "clippings"
  - "agent-memory"
  - "ai-industry"
---
![Image](https://pbs.twimg.com/media/HNxxWe-XMAAf7Ec?format=jpg&name=large)
...
2. Set four env vars (**PROVIDER=openai**, the NVIDIA **BASE\_URL**, your key, **MODEL=thinkingmachines/inkling**), plus **STRICT\_SCHEMA=false**.
