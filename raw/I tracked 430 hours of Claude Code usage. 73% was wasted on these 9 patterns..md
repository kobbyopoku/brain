...
created: 2026-05-02
description: "For 90 days I logged every single Claude Code session: timestamp, prompt, response, token count, model, exit reason.430 hours of work. 6 mil..."
tags:
  - "claude"
  - "claude-code"
---
![Image](https://pbs.twimg.com/media/HHP1mkyWMAAdNMv?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HHP4xdeXgAA9bm2?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HHP47mJXUAA-7FI?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HHP5C_EXYAELh3G?format=png&name=large)

**The 30-second fix:**

1. **Edit the prior message instead of follow-up.** Up-arrow -> edit -> re-send. The bad exchange gets replaced, not stacked.
2. **Hard cap conversations at 20 messages.** When you cross 20, ask Claude to summarize what's been done and start a fresh chat with that summary as the first message.
...
![Image](https://pbs.twimg.com/media/HHP4joGXsAEyQmZ?format=jpg&name=large)
...
2. **Aggressive /clear between every task.** Counter-productive. Lost context I genuinely needed. Better strategy: long-running session per project, but instrumented hooks and lean CLAUDE.md.
3. **Disabling all skills entirely.** Initially saved tokens. Then I started writing the same 200-token instructions in every prompt manually. Net negative. Better strategy: keep 3-4 skills you actually use, disable the rest.
4. **Off-peak hours scheduling.** Worked partially. Anthropic's peak-hour quota reduction is real (about 7% of users affected per their statement). For most people the bigger lever is the patterns above, not the time of day.
5. **Pure subscription downgrade (Pro -> less expensive plan).** Doesn't work. The cost per work-hour stayed the same, just got more painful when limits hit.
6. **Trying to identify the March 2026 caching bug.** Spent a day on it. Not worth it for individuals, Anthropic patched it. The bigger fish was my own context.
7. The audit script
...
![Image](https://pbs.twimg.com/media/HHP5ZigXMAEPKUY?format=jpg&name=large)
...
> Bookmark this, run the audit weekly until every line is in target Part 2 next week.. Telegram for daily claude optimization tips: [https://t.me/+\_ZWrQN7GuDA3ZDEy](https://t.me/+_ZWrQN7GuDA3ZDEy)