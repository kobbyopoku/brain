---
title: "The Claude Design Workflow That Actually Works."
source: "https://x.com/PrajwalTomar_/status/2056347864822083809"
author:
  - "[[@PrajwalTomar_]]"
published: 2026-05-18
created: 2026-05-21
description: "Most people are still opening Figma.Some are paying web designers thousands of dollars for landing pages that take two weeks to deliver.And ..."
tags:
  - "claude-design"
---
![Image](https://pbs.twimg.com/media/HImdZ4Yb0AAxoqf?format=jpg&name=large)
...
I have been using Claude Design across real projects at [@ignytlabs](https://x.com/@ignytlabs) and I have figured out the exact workflow that gets you to a finished, on-brand, professional design on the first pass without the endless back and forth.

There are 4 steps. Most people skip the first three and wonder why the results are mediocre.

Here is the full breakdown.

![Image](https://pbs.twimg.com/media/HImIjJ0a4AAP1mS?format=jpg&name=large)

## What Claude Design Actually Is

Quick context before we get into the workflow.

Claude Design lives inside your existing Claude subscription at [claude.ai/design](http://claude.ai/design). You need at least a Pro plan to access it.
...
![Image](https://pbs.twimg.com/media/HImc-fHawAEV0B_?format=jpg&name=large)
...
At [@ignytlabs](https://x.com/@ignytlabs) we build a design system for every single client before we touch a single page. It is the foundation of every project we take on. Claude Design just made that process dramatically faster.
...
For [@ignytlabs](https://x.com/@ignytlabs) I used:
...
![Image](https://pbs.twimg.com/media/HImJHh-akAAQMkK?format=jpg&name=large)
...
<video preload="none" tabindex="-1" playsinline="" aria-label="Embedded video" poster="https://pbs.twimg.com/amplify_video_thumb/2056329890954354689/img/v7xIcMmTsBOrb4SY.jpg" style="width: 100%; height: 100%; position: absolute; background-color: black; top: 0%; left: 0%; transform: rotate(0deg) scale(1.005);"><source type="video/mp4" src="blob:https://x.com/99a097e8-a2a9-41aa-a833-15d6407658af"></video>

![](https://pbs.twimg.com/amplify_video_thumb/2056329890954354689/img/v7xIcMmTsBOrb4SY.jpg?name=large)
...
![Image](https://pbs.twimg.com/media/HImNFm2bwAA8G74?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HImOcu-bgAASsQm?format=jpg&name=large)
...
At [@ignytlabs](https://x.com/@ignytlabs) we have templates for every deliverable we produce. Landing pages. Case studies. Client proposals. Onboarding guides. Every one of them has a pre-approved structure that we reuse across projects. This is what makes us fast.

<video preload="none" tabindex="-1" playsinline="" aria-label="Embedded video" poster="https://pbs.twimg.com/amplify_video_thumb/2056333501872648192/img/Hnk5iVZPdSOIBzPQ.jpg" style="width: 100%; height: 100%; position: absolute; background-color: black; top: 0%; left: 0%; transform: rotate(0deg) scale(1.005);"><source type="video/mp4" src="blob:https://x.com/828f2810-f673-44f6-a08c-3c0087276624"></video>

![](https://pbs.twimg.com/amplify_video_thumb/2056333501872648192/img/Hnk5iVZPdSOIBzPQ.jpg?name=large)
...
![Image](https://pbs.twimg.com/media/HImTT-ZbgAAR-mx?format=jpg&name=large)
...
→ Go to [claude.ai/design](http://claude.ai/design)
...
<video preload="none" tabindex="-1" playsinline="" aria-label="Embedded video" poster="https://pbs.twimg.com/amplify_video_thumb/2056338949115928576/img/5mujVeqq53D3pieM.jpg" style="width: 100%; height: 100%; position: absolute; background-color: black; top: 0%; left: 0%; transform: rotate(0deg) scale(1.005);"><source type="video/mp4" src="blob:https://x.com/5287f201-cb6a-406b-a652-2dae1c29d7ff"></video>

![](https://pbs.twimg.com/amplify_video_thumb/2056338949115928576/img/5mujVeqq53D3pieM.jpg?name=large)
...
![Image](https://pbs.twimg.com/media/HImVBpMaUAAw-dw?format=jpg&name=large)
...
This is the exact workflow we use at [@ignytlabs](https://x.com/@ignytlabs) for rapid client concepting. A client describes what they want. We run the 4-step workflow and have a high fidelity concept ready in under an hour. They approve it. We hand it off to Claude Code to build. The speed difference compared to the old way of working is significant.

![Image](https://pbs.twimg.com/media/HImVomcaoAEZT8l?format=jpg&name=large)
...
At [@ignytlabs](https://x.com/@ignytlabs) we are already seeing this in our client work. Concepts that used to take two weeks to produce are now ready in a day. That speed changes everything about how we pitch, how we onboard, and how fast we ship.
