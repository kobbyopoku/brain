...
created: 2026-07-21
description: "A software factory is harnessed loops at scale. You can run the loop with humans in it (light factory): trading judgment and concentration a..."
tags:
  - "clippings"
  - "software-factories"
  - "agentic-engineering"
---
![Image](https://pbs.twimg.com/media/HNjnfr1bkAEDDVa?format=jpg&name=large)
...
[@dexhorthy](https://x.com/@dexhorthy), co-founder of HumanLayer recently gave a great talk at AI Engineer World's Fair called ["Harness Engineering is not Enough: Why Software Factories Fail."](https://youtu.be/htM02KMNZnk?t=27219) worth checking out on this topic.

![Image](https://pbs.twimg.com/media/HNtOWAbasAAhgEJ?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNjddyQbEAAUdkq?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNjdk_obEAA5UR9?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNjflRVaIAARYSb?format=jpg&name=large)
...
You should read "[State machines in 2 minutes](https://x.com/DavidKPiano/status/2079209887158989231)" by [@DavidKPiano](https://x.com/@DavidKPiano)
...
That sounds like a lot of structure, but most of it is already there in any software, since any code can be expressed as a control-flow graph. So the only real novelty is that an agent insisting on autonomy is really just walking around a particular graph, and its freedom is constrained to the inside of a node. And here's the part people forget, which [Dex wrote down](https://github.com/humanlayer/12-factor-agents) a year ago: software was always going to have that structure. There's a reason we used to draw programs as flow charts.
