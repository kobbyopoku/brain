...
most people use claude code like a chatbot. i turned mine into a 24/7 dev team that remembers everything and gets smarter every session **bookmark this so as not to forget**
...
![Image](https://pbs.twimg.com/media/HHFATg1a8AAtrkz?format=jpg&name=large)
...
> [https://github.com/wshobson/agents](https://github.com/wshobson/agents) - 25k+ stars, production subagents across strategy, dev, security, design

> [https://github.com/davepoon/claude-code-subagents-collection](https://github.com/davepoon/claude-code-subagents-collection) - 100+ agents, drop-in for any workflow
...
> [https://github.com/wshobson/commands](https://github.com/wshobson/commands) - 1.7k+ stars, 15 workflows + 42 tools
...
![Image](https://pbs.twimg.com/media/HHFDi1nX0AADPy6?format=jpg&name=large)
...
> [https://github.com/ruvnet/claude-flow](https://github.com/ruvnet/claude-flow) - 11.4k+ stars, enterprise-grade multi-agent orchestration with persistent memory
...
![Image](https://pbs.twimg.com/media/HHFEeCkasAA1T35?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HHFFM0QbMAEWnrV?format=jpg&name=large)
...
**follow me** [@regent0x\_](https://x.com/@regent0x_) **to study and research only fresh alpha thx for reading. don't forget to bookmark this**