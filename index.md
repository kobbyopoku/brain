...
**Stats**: 145 sources · 668 entities · 211 concepts · 12 projects · 6 syntheses · last updated 2026-06-08 *(weekly lint pass — vedge project entry restored; llm-wiki-pattern citation count corrected)*
...
- [[wiki/concepts/llm-wiki-pattern]] — persistent, LLM-maintained markdown wiki built on top of curated raw sources. **5 wild citations now** (regent0x_ → nateherk → CyrilXBT → Shruti → Ole Lehmann).
...
- 🏢 [[wiki/projects/vedge]] — *(ROAM Labs owned product)* multi-tenant healthcare OS for African hospitals, clinics, labs, and pharmacies; Spring Boot 3.4.2 / Java 21 modular monolith (12 modules — auth, tenant, patient, billing, finance, expenses, lab, pharmacy, scheduling, interop, common, app) + Next.js 16 frontend + Flutter ×2 (patient + staff) + React Email; Postgres 18 + Flyway + Redis; active build since 2026-04-05. First project ever added to this brain.
